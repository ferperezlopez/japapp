...
- Lista de emails pre-aprobados para poder registrarse — decisión
  ...
  app.
- Aviso de "nuevo integrante" — existió brevemente como una tarjeta en
  Inicio (ventana fija de 7 días, sin marcar "visto") pero se sacó a
  pedido del usuario por poco valor (ver Changelog). Quien quiera
  enterarse de altas nuevas puede revisar `/miembros`.
...
- 2026-09-18: sacada la tarjeta "🎉 Se sumó/sumaron a JAPApp: X" de
  Inicio, a pedido explícito del usuario (le parecía poco relevante).
  El aviso de nombre parecido al crear cuenta (sección 3-4) no se tocó.
