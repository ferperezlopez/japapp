...
export function CopyableText({
  ...
  const handleClick = async () => {
    try {
      ...
      // Sin clipboard API (browser viejo, http sin TLS) no hay mucho más
      // para hacer acá — el texto sigue visible para copiarlo a mano.
    }
  };
    ...
    >
      ...
      {copied ? (
        <svg
          ...
          viewBox="0 0 20 20"
          fill="currentColor"
          className="h-3.5 w-3.5 text-eventos"
          aria-label="Copiado"
        >
          <path
            fillRule="evenodd"
