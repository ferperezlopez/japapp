// Siempre verde (paleta oficial de WhatsApp) para que sea reconocible de un
// vistazo, sin variantes outline/neutras — compartido entre el evento y las
// calculadoras para no duplicar el SVG del logo.
