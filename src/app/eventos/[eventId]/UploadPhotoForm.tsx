...
export function UploadPhotoForm({ eventId }: { eventId: string }) {
  ...
  return (
    <div>
      <label
        className={`inline-flex cursor-pointer items-center gap-2 rounded-lg bg-coral px-4 py-2 text-sm font-medium text-white transition-colors duration-200 hover:bg-coral-hover ${
